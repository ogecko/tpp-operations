...
Template.labelSheet.helpers({
	...
	instsize: (order) => (order.shipInstructions && order.shipInstructions.length<170 ? 'og-label-msg2' : 'og-label-msg2'),
	msgsize: (order) => (order.specialMessage && order.specialMessage.length<300 ? 'og-label-msg1' : 'og-label-msg2'),
