export function i18n(strings, ...values) {
	...
	// Placeholder. Currently just returns the English version ie default ES6 template function
	return String.raw(strings, ...values);
}

// Refer to http://jaysoo.ca/2014/03/20/i18n-with-es6-template-strings/
